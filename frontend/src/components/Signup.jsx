...
const Signup = () => {
  ...
  return (
    <div className="min-w-96 mx-auto">
        ...
        <h1 className='text-3xl text-black font-bold text-center'>Signup</h1>
        <form onSubmit={onSubmitHandler} action="">
          ...
          <div>
            <button type='submit' className='btn btn-block btn-sm mt-2 border border-slate-700  bg-white text-black'>Singup</button>
          </div>
        </form>
      </div>
    </div>
